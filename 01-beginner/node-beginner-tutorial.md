# Ergo Node Beginner Tutorial


## [Part 1: Headless Raspi Setup & Login](/01-beginner/part1-raspi-setup.md)
...
## [Part 2: Ergo Full Node Configure & Run](/01-beginner/part2-ergo-full-node.md) 
...
## [Part 3: Robustly run the node in the background as a systemd](/01-beginner/part3-robust-run-node-in-background-systemd.md)
...
## [Part 4: Satergo Wallet Full Node Wallet Setup](/01-beginner/part4-setup-satergo-full-node-wallet.md)
